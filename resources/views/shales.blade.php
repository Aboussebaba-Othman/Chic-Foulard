        ...
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                <div class="hero-content" style="transform-style: preserve-3d; perspective: 1000px;">                    
                    ...
                    <h1 class="display-2 text-white fw-bold mb-4" style="text-transform: uppercase; letter-spacing: 5px; text-shadow: 2px 2px 8px rgba(0,0,0,0.6), 0 0 30px rgba(132, 4, 68, 0.4); animation: fadeInUp 1.2s cubic-bezier(0.25, 0.46, 0.45, 0.94); font-size: 4.5rem;">Châles d'Exception</h1>
                    <p class="lead text-white mb-5" style="font-size: 24px; max-width: 700px; margin: 0 auto; text-shadow: 1px 1px 3px rgba(0,0,0,0.6); animation: fadeIn 1.5s cubic-bezier(0.25, 0.46, 0.45, 0.94); line-height: 1.5;">Entre tradition séculaire et élégance moderne</p>
