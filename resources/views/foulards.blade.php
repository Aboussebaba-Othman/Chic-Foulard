        ...
        <div class="row mb-5">
            <div class="col-lg-9 mx-auto text-center">
                <div class="section-title" style="position: relative; margin-bottom: 70px;">
                    ...
                    <h2 style="color: #2b2b2b; font-weight: 700; font-size: 50px; margin-bottom: 25px; position: relative; display: inline-block; animation: fadeInUp 1s ease; text-shadow: 1px 1px 0px rgba(132, 4, 68, 0.05);">Collection de Foulards</h2>
                    ...
                    <p class="collection-description">Découvrez notre élégante collection de foulards, alliant tradition marocaine et design contemporain pour une touche de sophistication intemporelle. Chaque pièce raconte une histoire d'artisanat et d'élégance.</p>
                </div>
            </div>
        </div>
        ...
        <div class="mb-5">
            <div class="row">   
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="product-image">
                            <img alt="Foulard Élégant" src="img/product/DSCF1045.jpg" class="img-fluid">
                                                      
                        </div>
                        <div class="product-title">
                            <h4>Foulard Élégant</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="product-image">
                            <img alt="Foulard Imprimé" src="img/product/DSCF1028.jpg" class="img-fluid">
                            
                        </div>
                        <div class="product-title">
                            <h4>Foulard Imprimé</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="product-image">
                            <img alt="Foulard Léger" src="img/product/DSCF1030.jpg" class="img-fluid">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="product-image">
                            <img alt="Foulard Coloré" src="img/product/DSCF1036.jpg" class="img-fluid">
                            
                        </div>
                        <div class="product-title">
                            <h4>Foulard Coloré</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="product-image">
                            <img alt="Foulard Brodé" src="img/product/DSCF1039.jpg" class="img-fluid">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="product-image">
                            <img alt="Foulard Premium" src="img/product/DSCF1040.jpg" class="img-fluid">
                            
                        </div>
                        <div class="product-title">
                            <h4>Foulard Premium</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="product-image">
                            <img alt="Foulard Traditionnel" src="img/product/DSCF100.jpg" class="img-fluid">
                                                        
                        </div>
                        <div class="product-title">
                            <h4>Foulard Traditionnel</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="product-image">
                            <img alt="Foulard Artisanal" src="img/product/DSCF102.jpg" class="img-fluid">
                            
                        </div>
                        <div class="product-title">
                            <h4>Foulard Artisanal</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="product-image">
                            <img alt="Foulard Moderne" src="img/product/DSCF10T5.jpg" class="img-fluid">
                                                      
                        </div>
                        <div class="product-title">
                            <h4>Foulard Moderne</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="product-image">
                            <img alt="Foulard Élégant" src="img/product/DSCF108.jpg" class="img-fluid">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="product-image">
                            <img alt="Foulard Traditionnel" src="img/product/DSCF1020.jpg" class="img-fluid">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="product-image">
                            <img alt="Foulard Artisanal" src="img/product/DSCF0906.jpg" class="img-fluid">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="product-image">
                            <img alt="Foulard Moderne" src="img/product/DSCF020.jpg" class="img-fluid">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="product-image">
                            <img alt="Foulard Élégant" src="img/product/DSCF028.jpg" class="img-fluid">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="product-image">
                            <img alt="Foulard Luxe" src="img/product/DSCF06.jpg" class="img-fluid">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="product-card">
                        <div class="product-image">
                            <img alt="Foulard Luxe" src="img/product/DSCF120.jpg" class="img-fluid">
